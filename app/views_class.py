...
class list(APIView, LoginRequiredMixin):
...
#@login_required 
class select(APIView, LoginRequiredMixin):
    login_url = 'accounts/login/'
    redirect_field_name ='redirect_to'
...
class tags_task(APIView, LoginRequiredMixin):
    login_url = 'accounts/login/'
    redirect_field_name ='redirect_to'
...
class filter(APIView, LoginRequiredMixin):
    login_url = 'accounts/login/'
    redirect_field_name ='redirect_to'
